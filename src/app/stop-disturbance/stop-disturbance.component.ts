...
@Component({
  selector: 'app-stop-disturbance',
  templateUrl: './stop-disturbance.component.html',
  styleUrls: ['./stop-disturbance.component.css'],
})
export class StopDisturbanceComponent implements OnInit {
  @Input() lang: string;
  wcMsg: string;
  moNumber: string;
  reportNumber: string;
